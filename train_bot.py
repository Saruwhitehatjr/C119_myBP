...
for word_tags in word_tags_list:
        ...
        tag = word_tags[1] # goodbye
        tag_index = classes.index(tag)#0
        labels_encoding[tag_index]=1 #1000
...
[(['Hi', 'there', '!', '!'], 'greeting'),
 ...
 (['Hey'], 'greeting'), (['Hola'], 'greeting'), 
 (['Hello'], 'greeting'), (['Bye'], 'goodbye'), 
 (['See', 'you', 'later'], 'goodbye'), (['Goodbye'], 'goodbye'), (['Nice', 'chatting', 'with', 'you', ',', 'bye'], 'goodbye'), (['Till', 'next', 'time'], 'goodbye')]